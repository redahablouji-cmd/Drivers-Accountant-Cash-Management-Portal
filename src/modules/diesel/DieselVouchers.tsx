        ...
        <div className="flex-1 overflow-y-auto divide-y divide-slate-100">
          {drivers.length === 0 ? (
            ...
            <button key={driver.id}
              onClick={() => { if (selectedTruck === driver.vehicle_plate) return; setSelectedTruck(driver.vehicle_plate || ''); setIsCreating(false); setFormData({ voucherNumber: '', date: new Date().toISOString().split('T')[0], truckPlate: driver.vehicle_plate || '', driverName: '', kmPrecedent: '', kmActuel: '', lavageGraissage: '', gasoilDhs: '', gasoilLiters: '', prixLitre: '', station: '' }); setConsoOverridden(false); }}
